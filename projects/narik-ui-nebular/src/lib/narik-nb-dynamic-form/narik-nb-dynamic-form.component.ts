...
@Component({
  ...
  templateUrl: "narik-nb-dynamic-form.component.html",
  providers: [
    {
      provide: NarikDynamicForm,
      useExisting: forwardRef(() => NarikNebularDynamicForm)
    }
  ]
})
export class NarikNebularDynamicForm extends NarikDynamicForm {
  columnWidth = 100;
  groupCount: number;
