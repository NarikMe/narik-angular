...
@Component({
  selector: "narik-dynamic-form , narik-swimlane-dynamic-form",
  templateUrl: "narik-swimlane-dynamic-form.component.html",
  providers: [
    {
      provide: NarikDynamicForm,
      useExisting: forwardRef(() => NarikSwimlaneDynamicForm)
    }
  ]
})
export class NarikSwimlaneDynamicForm extends NarikDynamicForm {
  columnWidth = 100;
  groupCount: number;
