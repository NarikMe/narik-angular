...
import { DialogContainer, DialogOverlayContainer, DialogRef, DialogInputContent } from "./services/DialogService";
...
export const DIALOG_INPUT_COMPONENT = new InjectionToken<Type<DialogInputContent>>(
...
export const DEFAULT_DATA_STORAGE_KEY = new InjectionToken<string>("DefaultDataStorageKey");
...
export const AUTHENTICATION_LOGIN_END_POINT = new InjectionToken<string>("AUTHENTICATION_END_POINT");
export const AUTHENTICATION_LOGOUT_END_POINT = new InjectionToken<string>("AUTHENTICATION_END_POINT");
export const AUTHENTICATION_REFRESH_END_POINT = new InjectionToken<string>("AUTHENTICATION_REFRESH_END_POINT");
